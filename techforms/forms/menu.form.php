        ...
        <table class="tab_cadre">
            <tbody>
                <tr class="tab_bg_2">
                    ...
                    <td>
                        <div class="no-wrap">
                            <input type="text" size="10" name="_date1" value="<?= date('Y-m-d', strtotime('-1 Day')) ?>" class="hasDatepicker">
                        </div>
                    </td>
                ...
                <tr class="tab_bg_2">
                    ...
                    <td>
                        <div class="no-wrap">
                            <input type="text" size="10" name="_date2" value="<?= date('Y-m-d', strtotime('-1 Day')); ?>" class="hasDatepicker">
                        </div>
                    </td>
                </tr>
